...
#            default_storage.delete(path)
        ...
        #print(res)
        return Response({"transcript": transcript, "confidence": confidence, "wpm": wpm, "indexArray": indexArray, "corpus": corpus, "tok": tok, "listSyn": listSyn, "pitch": f, "filler_count": filler_count})
    return Response({"message": "Hello, world!"})
